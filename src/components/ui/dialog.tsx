  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "fixed inset-x-0 bottom-0 top-auto z-[150] flex flex-col w-full max-w-none max-h-[90vh] gap-4 border-t border-x-0 border-b-0 bg-background shadow-lg duration-200 rounded-t-2xl",
        // Mobile padding with safe area support
        "p-6 pb-[max(1.5rem,env(safe-area-inset-bottom,1.5rem))]",
        ...
        "lg:inset-x-auto lg:inset-y-auto lg:left-[50%] lg:top-[50%] lg:translate-x-[-50%] lg:translate-y-[-50%] lg:max-w-lg lg:max-h-[85vh] lg:rounded-lg lg:border lg:shadow-xl lg:grid lg:overflow-auto",
        // Desktop animations: zoom and slide from center
